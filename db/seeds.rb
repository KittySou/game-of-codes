...
answer_5 = Answer.create!(content: "4", question: question_1, right_answer: true)
answer_6 = Answer.create!(content: "1", question: question_1)
answer_7 = Answer.create!(content: "5", question: question_1)
answer_8 = Answer.create!(content: "8", question: question_1)

question_3 = Question.create!(content: "3+3", deck: deck_1)
answer_9 = Answer.create!(content:  "6", question: question_1, right_answer: true)
answer_10 = Answer.create!(content: "1", question: question_1)
answer_11 = Answer.create!(content: "5", question: question_1)
answer_12 = Answer.create!(content: "8", question: question_1)

question_4 = Question.create!(content: "4+4", deck: deck_1)
answer_13 = Answer.create!(content: "8", question: question_1, right_answer: true)
answer_14 = Answer.create!(content: "1", question: question_1)
answer_15 = Answer.create!(content: "5", question: question_1)
answer_16 = Answer.create!(content: "2", question: question_1)

question_5 = Question.create!(content: "5+5", deck: deck_1)
answer_17 = Answer.create!(content: "10", question: question_1, right_answer: true)
answer_18 = Answer.create!(content: "1", question: question_1)
answer_19 = Answer.create!(content: "5", question: question_1)
answer_20 = Answer.create!(content: "8", question: question_1)
